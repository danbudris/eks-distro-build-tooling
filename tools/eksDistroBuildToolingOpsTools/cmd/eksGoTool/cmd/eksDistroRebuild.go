...
import (
	...
	prowJobs "github.com/aws/eks-distro-build-tooling/tools/eksDistroBuildToolingOpsTools/pkg/prowJobGenerator"
)
...
func init() {
	...
	eksDistroRebuildCustomProwJob.Flags().StringP(K8sVersionFlag, "k", "", "EKS D Kubernetes version to rebuild")
...
func eksDistroRebuildProwJob(ctx context.Context) error {
	...
	baseSha, headSha, err := git.GetHeadAndBaseHashes(constants.EksDGitRepoUrl, branchHead); if err != nil {
