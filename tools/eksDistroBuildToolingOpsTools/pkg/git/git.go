...
// GetHeadAndBaseHashes given a remote git repository and branch returns hash of the last n and n-1 commits
// on that branch in the repository. Useful for commit comparison and rebasing.
